        ...
        <div class="auto-container clearfix">
          <div class="top-left clearfix">
            <div class="text">
              ...
              Us Now :
              <a href="tel:+12396860550" class="number">+123 9686 0550
              </a>
            </div>
          </div>
        ...
        <div class="inner-container">
          <div class="auto-container clearfix">
            ...
            <div class="logo-outer">
              <div class="logo">
                <a href="index.php"><img src="images/main-logo.png" height="200" width="200"
                    alt="LOGO" /></a>
              </div>
            </div>
            ...
            <div class="nav-outer clearfix">
              ...
              <nav class="main-menu navbar-expand-md navbar-light">
                ...
                <div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
                  <ul class="navigation clearfix">
                    <li><a href="./E-book-writing.php">eBook Writing</a></li>
                    <li><a href="#">Book Publishing</a></li>
                    <li><a href="#">Book Promotion</a></li>
                    <li class="dropdown">
                      <a href="#">Services</a>
                      <ul>
                        <li>
                        ...
                        <li>
                          <a href="#">Artical Publication</a>
                        </li>
                        <li>
                          <a href="#">Ghost Writing</a>
                        </li>
                        <li>
                          <a href="#">Book Proofreading</a>
                        </li>
                        <li>
              ...
              <div class="mobile-menu">
                ...
                <nav class="menu-box">
                  <div class="nav-logo">
                    <a href="index.php"><img src="images/main-logo.png" height="120" width="120"
                        alt="sidebar-Logo" class="mx-5" title="" /></a>
                  </div>
                  <ul class="navigation clearfix">
